...
def preJets(process, jSrc, jupSrc, jdownSrc, vSrc, metSrc,mSrc, eSrc, **kwargs):
    ...
    if doFullJESUnc :
        ...
        if runningLocal : fName = "../../NtupleTools/data/Summer16_23Sep2016V4_MC_UncertaintySources_AK4PFchs.txt" 
        else :
            cmsswversion=os.environ['CMSSW_VERSION']
            fName = "{0}/src/FinalStateAnalysis/NtupleTools/data/Summer16_23Sep2016V4_MC_UncertaintySources_AK4PFchs.txt".format(cmsswversion)
