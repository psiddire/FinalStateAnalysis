...
_DATA_FILES = {
    '2018' : {
        'tauvse'        : os.path.join(_DATA_DIR_2018, 'TauID_SF_eta_DeepTau2017v2p1VSe_2018ReReco.root'),
        'antiele'       : os.path.join(_DATA_DIR_2018, 'TauID_SF_eta_antiEleMVA6_2018ReReco.root'),
        'tauvsmu'       : os.path.join(_DATA_DIR_2018, 'TauID_SF_eta_DeepTau2017v2p1VSmu_2018ReReco.root'),
        'antimu'        : os.path.join(_DATA_DIR_2018, 'TauID_SF_eta_antiMu3_2018ReReco.root'),
        'tauvsjet'      : os.path.join(_DATA_DIR_2018, 'TauID_SF_pt_DeepTau2017v2p1VSjet_2018ReReco.root'),
        'tauvsjetEMB'   : os.path.join(_DATA_DIR_2018, 'TauID_SF_pt_DeepTau2017v2p1VSjet_2018ReReco_EMB.root'),
        'mva'           : os.path.join(_DATA_DIR_2018, 'TauID_SF_pt_MVAoldDM2017v2_2018ReReco.root'),
        'tauvsjetdm'    : os.path.join(_DATA_DIR_2018, 'TauID_SF_dm_DeepTau2017v2p1VSjet_2018ReReco.root'),
