...
class MEtSys:
    ...
    def ShiftResponseMet(self, metPx, metPy, genVPx, genVPy, visVPx, visVPy, njets, bkgdType, sysShift):
        ...
        #File = ROOT.TFile.Open("/afs/hep.wisc.edu/home/psiddire/CMSSW_9_4_9/src/FinalStateAnalysis/TagAndProbe/data/PFMEtSys_2017.root")
        #mean = -File.Get(histoName[bkgdType][jets]).Interpolate(genVPt)*genVPt
        mean = -responseHist[bkgdType][jets].Interpolate(genVPt)*genVPt
        shift = sysShift*mean
...
def MEtSystematics(fileName):
    return MEtSys(fileName)                                                                                                 
